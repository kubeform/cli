...
func NewCmdGenModule(parent string, f cmdutil.Factory) *cobra.Command {
	var directory, providerName, providerSource, source, token, genSecretNamespace string
	var apply bool
...
func (o *GenModuleOptions) Run() error {
	err := generateModuleTRD(o.Source, o.ModuleName, o.ProviderName, o.ProviderSource, o.Directory, o.Token, o.Apply, o.Kubeconfig, o.GenSecretNamespace)
	if err != nil {
		return err
	}
...
func generateModuleTRD(source, moduleName, providerName, providerSource, directory, token string, apply bool, kubeconfig *string, credSecretNamespace string) error {
